...
const EditPage = () => {
    ...
    const getOne = (id) => {
        ...
        axios.get(`https://xurshidbek-server.onrender.com/data/${id}`).then((data) => {
...
axios.put(`https://xurshidbek-server.onrender.com/data/${id}`, obj).then((res) =>  {
    ...
    <>
     <Container>
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Form.Control value={title} type="text"  placeholder="Hotel Name" onChange={(e) => setTitle(e.target.value)} />
